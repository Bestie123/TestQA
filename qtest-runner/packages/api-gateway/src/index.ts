...
// Deprecation registry: prefix → { deprecatedAt, removalAt, message }
const deprecationRegistry: Record<string, { deprecatedAt: string; removalAt?: string; message?: string }> = {
  // Example: mark old endpoints as deprecated
  // '/api/old-endpoint': { deprecatedAt: '2026-01-01', removalAt: '2026-07-01', message: 'Use /api/new-endpoint instead' },
};
