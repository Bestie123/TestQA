...
| [Web UI](/web-ui) | Theme system (7 themes), settings (69 toggles + drag mode), Docs iframe |
| [Execution Flow](/flow) | How a test case executes from UI to browser |
| [Electron Debug](/electron-debug) | MCP tools for Electron Desktop debugging: persistent WS, replay, event stream |
| [Planned Features](/planned-features) | 5 feature specs: Event Stream, CDP, Persistent Session, Replay Editor, DOM Inspector |
...
| [Jira Authentication](/reference/jira-authentication) | Jira Server PAT setup for Zephyr Sync |
...
- **289** unit tests across 8 test suites
- **9** packages all build with 0 TypeScript errors
- **10** zephyr-client tests for Zephyr Scale API integration
