...
**Current coverage:** 289 tests across 8 suites:
...
| **gateway** | **35** | `api-gateway/src/__tests__/gateway.test.ts` |
| **step-library** | **27** | `step-library-service/src/__tests__/steps.test.ts` |
| **execution** | **12** | `execution-service/src/__tests__/execution.test.ts` |
| **zephyr-client** | **10** | `testcase-service/src/__tests__/zephyr-client.test.ts` |
