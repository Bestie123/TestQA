Index: docs/archive/REFACTOR_PLAN.md
===================================================================
...
| Реализовано (✅) | 25 / 146 |
| Частично (🔶) | 4 / 146 |
| Не реализовано (❌) | 117 / 146 |
| Сервисов | 7 |
| MCP инструментов | 2 (mcp-browser, mcp-qtest-debug) |
| Inject-скрипт | ~700 строк, 3 канала инжекции |

## Приоритеты (по Impact)

### P0 — Критичные для Jira/Zephyr тестирования
- [ ] iframe: same-origin + cross-origin postMessage bridge
- [ ] Shadow DOM: composedPath() для корректных селекторов
- [ ] SPA Navigation: monkey-patch pushState/replaceState/popstate
- [ ] Assertion Engine: генерация ожидаемого результата (не assertVisible, а "Появилась форма")
- [ ] Error Tracking: window.onerror + unhandledrejection
- [ ] Jira/Zephyr специфика: AUI, Froala, transition screens, plugin iframe'ы
- [ ] Cookie Consent авто-детекция

### P1 — Важные
- [ ] touch/wheel события
- [ ] CSS Animation tracking (transitionend/animationend)
- [ ] File upload (input type="file")
- [ ] Multi-window (window.open interception)
- [ ] contentEditable rich text
- [ ] `<dialog>` element tracking
...
### Обновить:
- [ ] ARCHITECTURE.md — новые модули, порты
- [ ] AGENTS.md — новые правила для assert, iframe
- [ ] USAGE.md — новые функции
- [ ] GAP_ANALYSIS.md — обновить статусы
- [ ] STATUS.md — Iteration 6, 7, 8, 9

### Создать:
- [ ] TESTING.md — руководство по тестированию на реальных сайтах
- [ ] ASSERTIONS.md — как работают assertion'ы
