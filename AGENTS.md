...
| `npm run lint:all` | Линтинг всех пакетов |
| `npx ts-node scripts/e2e-test-full.ts` | Полный E2E тест (запись + steps + executor + user switch) |
...
CREATE TABLE composite_step_items (
  ...
  library_step_id TEXT,                    -- опциональная ссылка на library_steps
  action TEXT NOT NULL,
  selector TEXT DEFAULT '',
  value TEXT DEFAULT '',
  url TEXT DEFAULT '',
  text TEXT DEFAULT '',
  parameter_bindings_json TEXT DEFAULT '{}', -- hint: какие параметры куда подставляются
